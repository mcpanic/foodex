...
class ManageCenter extends FoodExScreen
{
	public function ManageCenter(target:MovieClip, x_coor:Number, y_coor:Number, titleText:String, buttonText1:String, buttonText2:String)
	{
	...
	private function attachScreen()
	{
		...
		var middlescreen:MovieClip = this.target.createscreen.attachMovie("XScreen2", "screen_center", this.target.createscreen.getNextHighestDepth(), {_x:xcoor, _y:(ycoor+50)});
